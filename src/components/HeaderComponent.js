...
class Header extends Component {
    ...
    handleLogin(event){
        this.toggleModal();
        alert("Username: "+ this.username.value + " Password: " + this.password.value3 + " Remember : "+ this.remember.checked);
                    ...
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <Nav className ="ml-auto" navbar>
                                <NavItem>
                                    <Button outline style={{color: '#FFFFFF', borderColor:'#FFFFFF'}} onClick={this.toggleModal}>
